...
def upload_to_s3(**context):
    local_path = context['ti'].xcom_pull(task_ids='crawl_pbbrand_shingmulnara', key='local_path')
    s3_key = context['ti'].xcom_pull(task_ids='crawl_pbbrand_shingmulnara', key='s3_key')
