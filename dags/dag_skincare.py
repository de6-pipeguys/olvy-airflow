...
def crawl_product_info(**context):
    ...
    if dag_id == 'rank_crawl_afternoon_skincare':
        time_str = "170100"
    elif dag_id == 'rank_crawl_morning_skincare':
        time_str = "093000"
    else:
        time_str = "000000"
...
with DAG(
    dag_id='rank_crawl_morning_skincare',
...
with DAG(
    dag_id='rank_crawl_afternoon_skincare',
    default_args=default_args,
    ...
    start_date=datetime(2024, 7, 1, tzinfo=timezone("Asia/Seoul")),
    catchup=False,
    tags=['skincare', 'ranking', 'afternoon'],
) as dag:
